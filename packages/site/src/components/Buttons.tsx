...
export const GetChainIdButton = (props: ComponentProps<typeof Button>) => {
  return <Button {...props}>Get chainId</Button>;
}

export const ListKeysButton = (props: ComponentProps<typeof Button>) => {
